...
class MickeyClock:
    def __init__(self, center_point):
        ...
        self.bg = pygame.image.load('mickeys_clock/images/mickey_no_arms.png')
        self.hand_min_img = pygame.image.load('mickeys_clock/images/mickey_right-hand.png')
        self.hand_sec_img = pygame.image.load('mickeys_clock/images/mickey_left-hand.png')
